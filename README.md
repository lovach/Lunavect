...
<p>
  <a href="https://github.com/lovach/Lunavect/releases/download/v0.1.6/Lunavect-0.1.6.dmg"><img src="docs/images/download-macos.svg" width="256" height="56" alt="Download Lunavect for macOS — DMG"></a>
</p>
...
Or [download the DMG](https://github.com/lovach/Lunavect/releases/download/v0.1.6/Lunavect-0.1.6.dmg) and drag **Lunavect** to **Applications**. The release is Developer ID signed and notarized by Apple.
