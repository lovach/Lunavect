...
/path/outside-repository/dmg-venv/bin/python scripts/package-dmg.py \
  --app '/path/to/Notarized-157/Lunavect.app' \
  --output '/path/to/release-assets/Lunavect-0.1.4.dmg'
```
